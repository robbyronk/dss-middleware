package org.cru.give.service.impl;
...
@Default
public class DrawRunServiceImpl implements DrawRunService
{
	...
	/* (non-Javadoc)
	 * @see org.cru.give.service.impl.DrawRunServic#getLatestCreditCardDrawStartDateAndTime()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.cru.give.service.impl.DrawRunServic#getLatestEFTDrawStartDateAndTime()
	 */
	@Override
